                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <!-- Add the style="display: none;" to hide the filterSelect initially -->
                                                <select class="custom-select" id="filterSelect" style="display: none;">
                                                    <option value="">Select Filter</option>
                                                </select>
                                                <input type="text" class="form-control" id="searchBh" placeholder="Search Boarding Houses">
                                                <div class="input-group-append">
                                                    <button id="searchBtn" class="btn btn-success form-control"><i class="fas fa-search"></i></button>
                                                </div>
                                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="boardingHouseList" style="height: 720px;  overflow:auto">
            ...
            <script>
                ...
                $('#filterBy').change(function() {
                    ...
                    boardingHouseMaps.forEach(function(element) {
                        ...
                        if (element.bhLng && element.bhLat) {
                            var marker = L.marker([element.bhLng, element.bhLat], {
                                icon: greenIcon
                            }).addTo(map);
                        }
                    });
                ...
                function searchData(value) {
                    ...
                    value.forEach(function(boardingHouse) {
                        ...
                        listContent += '<li class="list-group-item d-flex justify-content-between">' + boardingHouse.bhName + '<button id="profileBtn" class="btn btn-success btn-sm" onclick="openMoreInfoCanvas(\'' +
                            ...
                            '\', \'' + boardingHouse.bhLng + '\', \'' + boardingHouse.bhLat +
                            '\')"><i class="fas fa-info"></i></button>' + '</li>';
                        // Add more details as needed
                        if (boardingHouse.bhLng && boardingHouse.bhLat) {
                            let icon = null
                            if (selectedSex !== '') {
                                if (selectedSex === "Male") {
                                    icon = maleIcon
                            ...
                            var marker = L.marker([boardingHouse.bhLng, boardingHouse.bhLat], {
                                icon: icon
                            }).addTo(map);
                            const escapedBhName = boardingHouse.bhName.replace(/'/g, "\'");
                ...
                function fetchBoardingHouses(searchQuery) {
                    ...
                    $.ajax({
                        url: 'assoc-fetch-boarding-houses',
                        method: 'POST',
                        headers: {
                ...
                function updateMarkersAndView(data) {
                    ...
                    data.forEach(function(element) {
                        if (element.bhLng && element.bhLat) {
                            ...
                            bounds.push([element.bhLng, element.bhLat]);
                    ...
                    data.forEach(function(element) {
                        ...
                        // $('#boardingHouseList').append('<p>' + element.bhName + '</p>');
                    });
                }

                function openMoreInfoCanvas(bhName, bhType, bhSexAccepted, opFullname, opSex, opContactNo, tenantCount, bedCount, bhLng, bhLat) {
                    ...
                    if (bhLng !== undefined && bhLat !== undefined) {
                        console.log('Zooming to marker coordinates:', bhLng, bhLat);
                        ...
                        var marker = L.marker([bhLng, bhLat], {
                            icon: icon
                        }).addTo(map);
                        ...
                        console.error('Invalid marker coordinates:', bhLng, bhLat);
                    }
